<%-- 
    Document   : admin_adminedit
    Created on : Jan 14, 2023, 10:28:30 AM
    Author     : Usamah
--%>
    ...
    <body>
        ...
        <main>
            ...
            <div class="wrapper">
                ...
                <form action="admin_adminedit.do" method="POST" class="form">
                   <div class="inputfield">
                      <label>ADMIN ID</label>
                      <input type="text" class="input" name="adminId" value="<%= adminId %>" required readonly>
                   </div>
                   <div class="inputfield">
                      <label>Name</label>
                      <input type="text" class="input" name="adminName" value="<%= adminName %>" required>
                   </div>
                    <div class="inputfield">
                      <label>Email Address</label>
                      <input type="text" class="input" name="adminEmail" value="<%= adminEmail %>">
                   </div> 
                   <div class="inputfield">
                      <label>Phone Number</label>
                      <input type="text" class="input" name="adminNumber" value="<%= adminNumber %>">
                   </div> 
                  <div class="inputfield">

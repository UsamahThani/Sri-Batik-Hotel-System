<%-- 
    Document   : admin_staffregister
    Created on : Jan 13, 2023, 6:52:26 PM
    Author     : Usamah
--%>
            ...
            <div class="wrapper">
                ...
                <form action="register.do" method="POST" class="form">
                   <div class="inputfield">
                      ...
                      <input type="text" class="input" name="staffId" required>
                   </div>
                   <div class="inputfield">
                      <label>Name</label>
                   ...
                   <div class="inputfield">
                      ...
                      <input type="text" class="input" name="staffNumber">
                   </div> 

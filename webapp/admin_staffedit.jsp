<%-- 
    Document   : admin_staffedit
    Created on : Jan 13, 2023, 8:22:56 PM
    Author     : Usamah
--%>
    ...
    <body>
        ...
        <main>
            ...
            <div class="wrapper">
                ...
                <form action="admin_staffedit.do" method="POST" class="form">
                   <div class="inputfield">
                      <label>Staff ID</label>
                      <input type="text" class="input" name="staffId" value="<%= staffId %>" required readonly>
                   </div>
                   <div class="inputfield">
                      <label>Name</label>
                      <input type="text" class="input" name="staffName" value="<%= staffName %>" required>
                   </div>
                    <div class="inputfield">
                      <label>Email Address</label>
                      <input type="text" class="input" name="staffEmail" value="<%= staffEmail %>">
                   </div> 
                   <div class="inputfield">
                      <label>Phone Number</label>
                      <input type="text" class="input" name="staffNumber" value="<%= staffNumber %>">
                   </div> 
                  <div class="inputfield">

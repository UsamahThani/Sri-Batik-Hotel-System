<%-- 
    Document   : admin_adminregister
    Created on : Jan 14, 2023, 10:15:33 AM
    Author     : Usamah
--%>
            ...
            <div class="wrapper">
                ...
                <form action="register.do" method="POST" class="form">
                   <div class="inputfield">
                      ...
                      <input type="text" class="input" name="adminId" required>
                   </div>
                   <div class="inputfield">
                      <label>Name</label>
                   ...
                   <div class="inputfield">
                      ...
                      <input type="text" class="input" name="adminNumber">
                   </div> 

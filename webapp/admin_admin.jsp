<%-- 
    Document   : admin_admin
    Created on : Jan 14, 2023, 9:57:24 AM
    Author     : Usamah
--%>
...
<html>
    ...
    <body>
        ...
        <%
            ...
            String staffSQL = "SELECT * FROM admin";
        ...
        <main>
            ...
            <div class="container">
                <div class="btn">
                    <button onclick="document.location='admin_adminregister.jsp'" class="register_btn">Register Admin</button>
                </div><br>
                <div class="table">
                    <table class="stafftable">
                        ...
                        <tr>
                            <%
                                ...
                                String adminNumber = rs.getString(3);
                                %>
                            <td><%= adminId %></td>
                            <td><%= adminName %></td>
                            <td><%= adminEmail %></td>
                            <td><%= adminNumber %></td>
                            <td><button onclick="document.location='admin_adminedit.jsp?adminId=<%= adminId %>&adminName=<%= adminName %>&adminEmail=<%= adminEmail %>&adminNumber=<%= adminNumber %>'">Edit</button> 
                                <button onclick="document.location='admin_admindelete.do?adminId=<%= adminId %>'">Delete</button></td>
                        </tr>
                        <% } %>
                    </table>
                </div>    

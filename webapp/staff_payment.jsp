...
<html>
    ...
    <body>
        ...
        <jsp:useBean id="cust" class="com.hsb.model.CustomerBean" scope="session"/>
        ...
        <main>
            ...
            <div class="wrapper">
                ...
                <form class="form" action="staff_payment.do" method="POST">
                    <div class="inputfield">
                        <label>Room Number</label>
                        <input type="text" class="input" readonly value="${cust.custRoomNum} " name="roomNum" required>
                    </div>
                    <div class="inputfield">
                        <label>Customer Name</label>
                        <input type="text" class="input" readonly value=" ${cust.custName} " name="custName" required> 
                    </div> 
                    <div class="inputfield">
                        <label>Period of Stay (night)</label>
                        <input type="number" class="input" readonly value="${cust.custPeriod}" name="period" required>
                    </div> 
                    <div class="inputfield">
                        <label>Room Price</label>
                        <input type="text" class="input" readonly value="${cust.custRP}" name="roomPrice" required>
                    </div> 
                    <div class="inputfield">
                        <label>Total Payment</label>
                        <input type="text" class="input" readonly value="${cust.custTP}" name="totalPayment" required>
                    </div> 
                    <div class="inputfield">

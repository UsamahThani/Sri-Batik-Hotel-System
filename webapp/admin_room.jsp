    ...
    <body>
        ...
        <main>
            ...
            <c:forEach items="${result.rows}" var="row">
                ...
                <fieldset class="roomdetails">
                    <legend>Room ${row.roomNumber}</legend>
                    <table>
                        <tr>
                            <th>Room Type: </th>
                            <td>${row.roomType} </td>
                        ...
                        <tr>
                            <th>Room Price: </th>
                            <td>RM <fmt:formatNumber value="${row.roomPrice}" type="number" maxFractionDigits="2" minFractionDigits="2"/>/night</td>
                        </tr>
                        <tr>
                            <th>Room Status </th>
                            <td>
